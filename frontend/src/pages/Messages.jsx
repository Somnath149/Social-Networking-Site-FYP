...
function Messages({ mwidth }) {
  ...
  return (
    ...
    <div className={`${mwidth ? "lg:w-[50%] w-full min-h-[100vh] flex flex-col bg-[var(--bg)] gap-[20px] p-[10px]" :
      ...
      {!prevChatUsers?.length  ? (<TrendingPostLoop tp={true} />) : (

        <>
    
          
<div className={`w-full lg:w-[25%] h-[80px] fixed top-0 ${mwidth ? "right-[50%]" : "right-0"}  z-50 flex items-center justify-between px-4 bg-[var(--bg)]`}>
